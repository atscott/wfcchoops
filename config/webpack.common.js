...
module.exports = {
    ...
    preLoaders: [
      {
        ...
        query: {
          ...
          replace:
              '$1.import($3).then(mod => mod.__esModule ? mod.default : mod)',
          flags: 'g'
        },
  ...
  plugins: [
     ...
     * href attributes, you can disable that by adding a "=href": false
     * property.
     * You can also enable it to other attribute by settings "=attName": true.
     *
     * The configuration supplied is map between a location (key) and an element
     * definition object (value)
     * The location (key) is then exported to the template under then
     * htmlElements property in webpack configuration.
     *
     * Example:
